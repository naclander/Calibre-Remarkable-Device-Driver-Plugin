...
class RemarkablePlugin(DevicePlugin):
    ...
    def startup(self):
        ...
        with self:
            ...
            sys.path.append(temp_unzip_path) # * For installing using zip file generated by the sh script
            
            target_path = os.path.join(temp_unzip_path, "target") 
            sys.path.append(target_path) # * For installing using calibre-customize -b ./ on the folder AFTER running the sh script
